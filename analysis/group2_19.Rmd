...
pdf("../submission preparation/graph_panels/panel5/data_summary.pdf", width = 14, height = 3)
...
```{r,eval = FALSE}
pdf("../submission preparation/graph_panels/panel5/input_hits.pdf", width = 5, height = 8)
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/volcano.pdf", width = 14, height = 8)
annotate_figure(figure,
                top = paste("Volcano plot",key),
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_raw.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Poisson-glmm DEGs\nin UMI counts (", nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_row = annotation_log2FC,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_VST.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = "VST data",
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```
```{r eval=FALSE}
png("../submission preparation/graph_panels/panel5/heatmap_raw.png", width = 500, height = 500)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Binomial-glmm DEGs\nin UMI counts (", nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         # annotation_row = annotation_log2FC,
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_deseq2.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("pb-DESeq2 DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         # annotation_row = annotation_log2FC,
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_binomial_glmm.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Binomial-glmm DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_MAST_donor.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("MAST DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_MMpoisson.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("MMpoisson DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/heatmap_Extra_hits.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Poisson-glmm DEGs \nnot identified by MMpoisson (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel5/dotplot.pdf", width = 7, height = 5)
dotplot(go_enrich)
pdf("../submission preparation/graph_panels/panel5/cnetplot.pdf", width = 12, height = 6)
cnetplot(go_enrich, categorySize="pvalue", foldChange=gene_list)
dev.off()
```
