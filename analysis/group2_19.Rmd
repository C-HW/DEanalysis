...
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/data_summary.pdf", width = 14, height = 3)
...
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/input_hits.pdf", width = 8, height = 8)
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/volcano.pdf", width = 14, height = 8)
annotate_figure(figure,
                top = paste("Volcano plot",key),
...
geom_histogram(fill="white", alpha=0.5, position="identity") + theme_bw() + theme(panel.grid = element_blank()) + xlab(NULL) + ylab("Count") + ylim(c(0,1000)) + ggtitle(titlelist[i]) + scale_colour_discrete(guide = guide_legend(title = NULL),labels = c("p-value", "adj.p-value"))
}
figure = ggarrange(plotlist = p, common.legend = TRUE, legend="bottom", nrow = 2, ncol = 4)
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/pvalue_hist.pdf", width = 14, height = 8)
annotate_figure(figure, top = as.character(key))
dev.off()
```
...
```{r, eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/violin_log2mean.pdf", width = 8, height = 8)
...
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/violin_freq.pdf", width = 8, height = 8)
...
```
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/heatmap_raw.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Poisson-glmm DEGs\nin UMI counts (", nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_row = annotation_log2FC,
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/heatmap_VST.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = "VST data",
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/heatmap_MAST_donor.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("MAST DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/heatmap_MMpoisson.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("MMpoisson DEGs \nnot identified by Poisson-glmm (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/heatmap_Extra_hits.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Poisson-glmm DEGs \nnot identified by MMpoisson (",nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```{r eval=FALSE}
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/dotplot.pdf", width = 7, height = 5)
dotplot(go_enrich)
pdf("~/Google Drive/My Drive/spatial/10X/graph_panels/panel5/cnetplot.pdf", width = 12, height = 6)
cnetplot(go_enrich, categorySize="pvalue", foldChange=gene_list)
dev.off()
```
