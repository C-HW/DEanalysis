...
pdf("../submission preparation/graph_panels/panel4/data_summary.pdf", width = 14, height = 3)
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/raw_library.pdf", width = 4, height = 3)
p_countbygroup
dev.off()
```
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/ttest_meandiff_logUMI_logCPM.pdf", width = 12, height = 3)
ggarrange(p_ttest_raw_cpm, p_ttest_raw_vst, p_ttest_raw_integrated, ncol = 3)
dev.off()
```
...
pdf("../submission preparation/graph_panels/panel4/input_hits.pdf", width = 6, height = 8)
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/volcano.pdf", width = 14, height = 3)
annotate_figure(figure,
                top = paste("Volcano plot",key),
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/heatmap_raw.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = paste0("Poisson-glmm DEGs\nin UMI counts (", nrow(mat)," DEGs)"),
         annotation_col = annotation_df, 
         annotation_row = annotation_log2FC,
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel3/heatmap_VST.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
         main = "VST data",
         annotation_col = annotation_df, 
         annotation_colors = annotation_colors,
...
```
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/heatmap_integrated.pdf", width = 5, height = 5)
pheatmap(mat[,rownames(annotation_df)], 
...
```{r eval=FALSE}
pdf("../submission preparation/graph_panels/panel4/dotplot.pdf", width = 6, height = 5)
dotplot(go_enrich)
pdf("../submission preparation/graph_panels/panel4/cnetplot.pdf", width = 12, height = 6)
cnetplot(go_enrich, categorySize="pvalue", foldChange=gene_list)
dev.off()
```
