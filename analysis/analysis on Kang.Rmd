...
for(i in 1:length(celltype)){
  ...
  Kang_pois_glmm_df[[cur_key]]$hits = identifyDEGs(Kang_pois_glmm_df[[cur_key]]$BH, Kang_pois_glmm_df[[cur_key]]$log2FC, subgroupsce@metadata$log2mean, subgroupsce@metadata$log2meandiff)
  
  
  
  # binom_glmm
  Kang_binom_glmm_df[[cur_key]] = binomial_glmm_DE(subgroupsce, comparison = "group_id", replicates = "ind", exp_batch = "sample_id")
  Kang_binom_glmm_df[[cur_key]]$hits = identifyDEGs(Kang_binom_glmm_df[[cur_key]]$BH, Kang_binom_glmm_df[[cur_key]]$log2FC, subgroupsce@metadata$log2mean, subgroupsce@metadata$log2meandiff)
