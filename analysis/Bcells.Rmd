...
To compare the results, the genes displayed in all of the plots below are restricted to the inputs of pois_glmm. That is, the genes not containing in the inputs of pois_glmm are excluded.
...
### Wilcox
```{r}
sort_log2FC = sort(abs(dflist[[6]][[cur_key]]$avg_log2FC[dflist[[6]][[cur_key]]$hits]), index.return = T, decreasing = T)
