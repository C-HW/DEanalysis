...
### Wilcox
```{r}
sort_log2FC = sort(abs(Kang_Wilcox_Seurat_df[[cur_key]]$avg_log2FC[Kang_Wilcox_Seurat_df[[cur_key]]$hits]), index.return = T, decreasing = T)
hitgenes_wilcox = Kang_Wilcox_Seurat_df[[cur_key]]$genes[which(Kang_Wilcox_Seurat_df[[cur_key]]$hits)][sort_log2FC$ix]
