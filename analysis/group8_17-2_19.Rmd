...
### pb-edgeR
```{r}
sort_log2FC = sort(edgeR.cpm[[cur_key]]$log2FC[edgeR.cpm[[cur_key]]$hits], index.return = T, decreasing = T)
...
### MAST
```{r}
sort_log2FC = sort(MAST_donor_df[[cur_key]]$log2FC[MAST_donor_df[[cur_key]]$hits], index.return = T, decreasing = T)
...
### MMvst
```{r}
sort_log2FC = sort(MMvst[[cur_key]]$log2FC[MMvst[[cur_key]]$hits], index.return = T, decreasing = T)
